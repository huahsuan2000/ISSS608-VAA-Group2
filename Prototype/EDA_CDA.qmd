...
![](images/clipboard-1352613092.png)
...
There are a filter bar that users can choose X and Y variable type whether they want categorical or numerical variable. After select type of variable user can select which variable in that type that they want to discover the relationship in the Select X/Y Variable filter. User click Submit botton to display in the visualization.

The visualization will be consisted of 4 possible pairs of x and y variable type. The visualization will shown in different plot as shown in table below

| X Variable Type | Y Variable Type | The Visualization |
|-----------------|-----------------|-------------------|
...
This allows users to explore different relationship between all variables and flexibility helps users view the data from different perspectives
